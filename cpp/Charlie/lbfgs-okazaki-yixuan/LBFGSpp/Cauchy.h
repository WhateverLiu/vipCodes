...
private:
  ...
  int search_greater(const Vector& brk, const IndexSet& ord, const Scalar& t, int start = 0)
  { 
  ...
  IndexSet ord;
  Vector brk, vecd, vecp, wact, cache;
...
public:
  ...
  void get_cauchy_point(
      BFGSMat<Scalar, true>& bfgs, const Vector& x0, const Vector& g, const Vector& lb, const Vector& ub,
      Vector& xcp, Vector& vecc, IndexSet& newact_set, IndexSet& fv_set
  //     // =======================================================================
  //     IndexSet &ord, Vector &brk, Vector &vecd, Vector &vecp, Vector &wact
  // // ===========================================================================
  ) 
  {
